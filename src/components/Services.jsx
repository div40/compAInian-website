    ...
    <Section id="how-to-use">
      <div className="container">
        <Heading
          ...
          text="CompAInion unlocks the potential of AI-powered applications"
        />
          ...
          <div className="relative z-1 flex items-center h-[39rem] mb-5 p-8 border border-n-1/10 rounded-3xl overflow-hidden lg:p-20 xl:h-[46rem]">
            ...
            <div className="relative z-1 max-w-[17rem] ml-auto">
              ...
              <p className="body-2 mb-[3rem] text-n-3">
                CompAInion unlocks the potential of AI-powered applications
              </p>
              <ul className="body-2">
          ...
          <div className="relative grid gap-5 z-1 lg:grid-cols-2">
            <div className="relative min-h-[39rem] border border-n-1/10 rounded-3xl overflow-hidden">
              ...
              <div className="absolute inset-0 flex flex-col justify-end p-8 bg-gradient-to-b from-n-8/10 to-n-8/90 lg:p-15">
                <h4 className="mb-4 h4">Image Editing</h4>
                <p className="body-2 mb-[3rem] text-n-3">
                  Enhance your photos easily using our AI app&apos;s image
            ...
            <div className="p-4 bg-n-7 rounded-3xl overflow-hidden lg:min-h-[46rem]">
              <div className="px-4 py-12 xl:px-8">
                ...
                <p className="body-2 mb-[2rem] text-n-3">
                  We use world&apos;s most powerful AI photo and video
                  generation engine. So, what will you create?
                </p>
